...
func TestSplit(t *testing.T) {
	...
	t.Run("testSplit_transmit_UCS2", func(t *testing.T) {
		testEncodingSplit(t, UCS2,
			134,
			"Hey Sanket, 🙈 it's Sunny from Greenpeace here Just wanted to pass on a massive thank you for signing our testonesms petition Together we can make a difference https://act.gp/jf",
			[]string{
				"",
				"",
				"002000770065002000630061006e0020006d0061006b00650020006100200064006900660066006500720065006e00630065002000680074007400700073003a002f002f006100630074002e00670070002f006a0066",
			},
			[]string{
				"Hey Sanket, 🙈 it's Sunny from Greenpeace here Just wanted to pass ",
				"on a massive thank you for signing our testonesms petition Together",
				" we can make a difference https://act.gp/jf",
			})
	})
